...
export const getTradeRate = async (
  ...
  if (!buyPoolId && buyAssetId !== thorchainAssetId) {
  ...
  if (!sellPoolId && sellAsset.assetId !== thorchainAssetId) {
  ...
  if (doubleSwap && sellPool && buyPool) {
    ...
    outputAmountBase8 = getDoubleSwapOutput(sellBaseAmount, sellAssetPoolData, buyAssetPoolData)
  } else {
    ...
    outputAmountBase8 = getSwapOutput(sellBaseAmount, poolData, toRune)
  }
