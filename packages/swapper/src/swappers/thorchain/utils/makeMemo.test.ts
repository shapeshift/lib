...
describe('makeMemo', () => {
  it('make a trade to usdc memo', () => {
    ...
    expect(memo).toEqual(
      'SWAP:8B36C1D19D4A2E9EB0CE3606EB48:0x8a65ac0E23F31979db06Ec62Af62b132a6dF4741:420'
    )
  })
  it('make a trade to eth memo', () => {
    ...
    expect(memo).toEqual('SWAP:ETH.ETH:0x8a65ac0E23F31979db06Ec62Af62b132a6dF4741:420')
  })
  it('make a trade to btc memo', () => {
    ...
    expect(memo).toEqual('SWAP:BTC.BTC:bc1qkw9g3tgv6m2gwc4x4hvdefcwt0uxeedfgag27h:420')
  })
})
