...
describe('makeSwapMemo', () => {
  it('should make a trade to usdc memo', () => {
    ...
    expect(memo).toEqual('s:ETH.USDC-B48:0x8a65ac0E23F31979db06Ec62Af62b132a6dF4741:420:ss:25')
  })
  ...
  it('should make a trade to eth memo', () => {
    ...
    expect(memo).toEqual('s:ETH.ETH:0x8a65ac0E23F31979db06Ec62Af62b132a6dF4741:420:ss:25')
  })
  ...
  it('should make a trade to btc memo', () => {
    ...
    expect(memo).toEqual('s:BTC.BTC:bc1qkw9g3tgv6m2gwc4x4hvdefcwt0uxeedfgag27h:420:ss:25')
  })
})
